...
When the query clearly matches one of the titles or categories above, pass
that exact value as the tool's 'title' or 'category' argument. Otherwise,
just pass the query text for a semantic search. Always call the tool before
answering.
"""
